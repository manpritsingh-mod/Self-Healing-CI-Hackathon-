...
class PromptBuilder:
    ...
    def build_root_cause_prompt(
        ...
        # OPTIMIZED: Removed last_50_lines completely to save massive tokens
        # The specific regex-extracted error_lines and stack_traces are sufficient.

        user_prompt = (
            "Analyze this CI/CD build failure and identify the root cause.\n\n"
            + "\n\n".join(sections)
            + "\n\n## Required Output (JSON)\n"
            "Return ONLY a valid JSON object. No markdown fences and no extra text.\n"
            "{\n"
    ...
    def build_fix_prompt(
        ...
        user_prompt = (
            ...
            "}\n"
            "\n"
            "IMPORTANT: Assign a confidence score (0-100) based on how certain you are this fix resolves the root cause. Be highly critical."
        )
